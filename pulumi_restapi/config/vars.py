...
__config__ = pulumi.Config('restapi')
...
class _ExportableConfig(types.ModuleType):
    ...
    def id_attribute(self) -> Optional[str]:
        ...
        """
        return __config__.get('idAttribute')
    ...
    def key_string(self) -> Optional[str]:
        ...
        permissions.
        """
        return __config__.get('keyString')

    @property
    def oauth_client_credentials(self) -> Optional[str]:
        """
        Configuration for oauth client credential flow using the https://pkg.go.dev/golang.org/x/oauth2 implementation
        """
        return __config__.get('oauthClientCredentials')
    ...
    def rate_limit(self) -> Optional[float]:
        ...
        """
        return __config__.get_float('rateLimit')

    @property
    def read_method(self) -> Optional[str]:
        """
        Defaults to `GET`. The HTTP method used to READ objects of this type on the API server.
        """
        return __config__.get('readMethod')
    ...
    def root_ca_file(self) -> Optional[str]:
        ...
        """
        return __config__.get('rootCaFile')

    @property
    def root_ca_string(self) -> Optional[str]:
        """
        When set, the provider will load a root CA certificate as a string for mTLS authentication. This is useful when the API
        server is using a self-signed certificate and the client needs to trust it.
        """
        return __config__.get('rootCaString')

    @property
    def test_path(self) -> Optional[str]:
        """
        ...
        """
        return __config__.get('testPath')
    ...
    def update_method(self) -> Optional[str]:
        ...
        """
        return __config__.get('updateMethod')
    ...
    @property
    def use_cookies(self) -> Optional[bool]:
        """
        Enable cookie jar to persist session.
        """
        return __config__.get_bool('useCookies')
